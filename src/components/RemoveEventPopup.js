...
function handleCancel(){
  ...
  return (
    <div className='container'>
       <form id='formulaire' enctype="multipart/form-data" method="post" onSubmit={deleteEvent}>
         Report Date: <strong>{stringifiedDate}</strong>
         <br />
          Client: <strong>{title}</strong>
                   
                                
                    <input style={{width:"230px",backgroundColor:"red",color:"white",borderRadius:"6px",border:"none",height:"40px",marginTop:"16px"}} type="Submit" value="Delete Reminder"></input>
                </form>
                <button onClick={handleCancel} style={{background:"none",border:"none",fontWeight:"600",marginTop:"8px",textDecoration:"underline"}} >Cancel</button>
