...
useEffect(() => {
  ...
  return (
    <div className='container'>
       <form id='formulaire' enctype="multipart/form-data" method="post" onSubmit={addEvent}>
         Report Date: <strong>{eventDetailsObject}</strong>
         <br />
                    <label>Client</label> 
                    <select value={selectedValue} name="receiver" onChange={handleChange} required style={{width:"230px"}}>
                <option value="" >Choose Client </option>
                  ...
                  return (
                    ...
                    <input style={{width:"230px",backgroundColor:"green",color:"white",borderRadius:"6px",border:"none",height:"40px",marginTop:"16px"}} type="Submit" value="Add Reminder"></input>
                </form>
    </div>
  )
}
