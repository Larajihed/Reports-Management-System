...
import DocumentPDF from "../Pages/DocumentPDF";
      ...
      <div className="popup">
        ...
        <div className="main" style={{ width: 800, height: 1390 }} ref={ref}>
            ...
            <div className="numbers-container">
              ...
              <div className="notes-container">
                <li>
                  ...
                  <span class="bold">
                    {" "}
                    {props.ResearchHours / 8} business days back*
                  </span>{" "}
                  and saved{" "}
                  <span className="bold">${props.ResearchHours * 125} ** </span>{" "}
                  by using Wonder for your research needs.
                </li>
                <li>
                  Your company's peak* throughput in a 24-hour period was{" "}
                  <span className="bold"> {props.peakHours} hours ***</span> of
                  research.
                </li>
                <li>
                  We know your team was hard at work this month using that extra
                  time to drive forward other key initiatives, here are some
                  other interesting ways to put those 453 hours into
                  perspective:
                </li>
              </div>
            </div>
          ...
          <div className="definitions-container">
            <p>
              * Business Days Back = hours of research done across a given time
              period, divided by 9 hours in a business day
              <br />
              ** Dollars Saved = Dollar amount it would take a client to perform
              requisite research (assuming a flat rate of $125 per hour) over a
              given time period minus dollar amount it would take for Wonder to
              perform the same amount of requisite research
              <br />
          ...
          <div className="right-section">
            ...
            <h4 style={{ marginTop: "16px", marginBottom: "48px" }}>
              Report Generated on <br></br> {props.addDate}
            </h4>
            <br></br>
